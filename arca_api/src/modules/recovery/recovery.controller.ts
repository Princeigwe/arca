...
export class RecoveryController {
  ...
  @ApiOperation({summary: "Retrieve a secret share for wallet recovery"})
  @Get(":walletAddress/secret-share")
  retrieveSecretShare(@Param('walletAddress') walletAddress: string) {
    return this.recoveryService.retrieveSecretShare(walletAddress)
  }
}
